...
const express = require('express'); // LocalLibrary
/** Node.js compression middleware. */
const compression = require('compression'); // LocalLibrary
/** Simple session middleware for Express. */
const session = require('express-session');
/** Node.js body parsing middleware. */
const bodyParser = require('body-parser'); // LocalLibrary
/** HTTP request logger middleware for node.js. */
const logger = require('morgan'); // LocalLibrary
...
const path = require('path'); // LocalLibrary
/** MongoDB ODM. */
const mongoose = require('mongoose'); // LocalLibrary
