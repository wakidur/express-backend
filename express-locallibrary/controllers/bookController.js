...
exports.book_create_get = function(req, res, next) {
    ...
    async.parallel({
        ...
        res.render('./book/bookFormView', { title: 'Create Book', authors: results.authors, genres: results.genres });
    });
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                res.render('./book/bookFormView', { title: 'Create Book', authors: results.authors, genres: results.genres, book: book, errors: errors.array() });
            });
            return;
        } else {
            // Data from form is valid. Save book.
