...
exports.book_create_get = function(req, res, next) {
	...
	async.paralley({
		...
		res.render('./book/bookForm', { title: 'Create Book', 
...
exports.book_create_get = function(req, res, next) { 
    ...
    async.parallel({
        ...
        res.render('./book/bookForm', { title: 'Create Book', authors: results.authors, genres: results.genres });
    });
...
exports.book_create_post = [
	...
	(req, res, next) => {
		...
		// Create a Book object with escaped and trimmed date.
		var book = new Book({
		...
		if(!errors.isEmpty()) {
			// There are errors. Render form again with sanitize 
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                res.render('./book/bookForm', { title: 'Create Book',authors:results.authors, genres:results.genres, book: book, errors: errors.array() });
            });
            return;
        }
        else {
