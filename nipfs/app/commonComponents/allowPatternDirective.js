/*
    Actor : Rasel Ahmed 
    Date :  28/08/2016  dd/MM/yyyy 
*/

/*  *********************** ============================ **********************************************
    *********************** ============================ **********************************************
      Reference link https://plnkr.co/edit/QHgV7m9jlSLPImxcFif2?p=preview
...
//  Reference link : https://codepen.io/TheLarkInn/post/angularjs-directive-labs-allowpattern-directive-more-fun-with-keycodes

//var directiveModule = angular.module('allowPatternDirective', []);

//directiveModule.directive('allowPattern', ['$filter', '$document', '$compile', '$parse',
